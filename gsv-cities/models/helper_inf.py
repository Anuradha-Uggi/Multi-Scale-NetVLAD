...
def get_aggregator(agg_arch='ConvAP', agg_config_pool1={}, agg_config_pool2={}, init_path=True):
    ...
    if 'cosplace' in agg_arch.lower():
        ...
        net_vlad_pool1 = netvlad.NetVLAD1(**agg_config_pool1)
        net_vlad_pool2 = netvlad.NetVLAD2(**agg_config_pool2)
        return [net_vlad_pool1, net_vlad_pool2]#netvlad.initialize_weights_msnv(init_path, net_vlad_pool1, net_vlad_pool2)     
